...
public class RegisterTest extends TestBase{
	...
	public void verifyRegisterWithNoDetails() {
		...
		Assert.assertTrue(registerpage.retrieveAllWarningMessagesStatus(dataprop.getProperty("policyWarningMessage"), dataprop.getProperty("firstNameWarningMessage"), 
